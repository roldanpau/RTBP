...
# zu: preimage of homoclinic point z (in Delaunay coords, with g=\pi)
cut -d ' ' -f 1-4 ../prtbp_del/intersecs_preimgs_unst_br1_SECg2.res > temp3
...
cut -d ' ' -f 6 ../intersec/intersecs_unst_br1.res > temp4

echo "0.95387536e-3 0" > $DATFILE	# mu, UNSTABLE

# H, p, z_u, \omega_pos, N
paste -d ' ' temp1 temp2 temp3 ../outer_circ/omega_neg_unst_br1.res \
