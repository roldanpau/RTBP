...
# zs: preimage of homoclinic point z (in Delaunay coords, with g=0)
cut -d ' ' -f 1-4 ../prtbp_del/intersecs_preimgs_st_br2_SECg.res > temp3
...
cut -d ' ' -f 6 ../intersec/intersecs_st_br2.res > temp4

echo "0.95387536e-3 1" > $DATFILE	# mu, STABLE

# H, p, z_u, \omega_pos, N
paste -d ' ' temp1 temp2 temp3 ../outer_circ/omega_pos_st_br2.res \
