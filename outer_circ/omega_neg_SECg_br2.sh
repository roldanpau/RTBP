...
datfile=omega_neg_SECg_br2.dat
resfile=omega_neg_SECg_br2.res
errfile=omega_neg_SECg_br2.err
...
cut -d ' ' -f 13-20 ../intersec_del_car/intersecs_unst_SECg_br2.res > temp2

# M: number of iterations to reach homoclinic point z from z_u
cut -d ' ' -f 2 ../approxint_del_car/approxints_unst_SECg_br2.res > temp3
