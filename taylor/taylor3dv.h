...
MY_FLOAT **taylor_coefficients_rtbp3dvA(MY_FLOAT t, MY_FLOAT *x, int order, int reuse_last_computation);
int       taylor_step_rtbp3dv(MY_FLOAT *ti, MY_FLOAT *x, int dir, int step_ctl,
