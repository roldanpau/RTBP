...
// ======================================
// FILE:          $RCSfile: orbitpdel_bwd_main.c,v $
...
// Poincare map.
// Given a point $p=(l,L,g,G)$, this function computes the backward orbit ${P^{-k}(p)}$
// for $k=1,2,\dots,n$.
//
// OVERALL METHOD
// ==============
...
//    2.1. Compute backward orbit of $x$ under the Poincare map: ${P^{-k}(x)}$.
