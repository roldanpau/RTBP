...
// ====================================================================
// FILE:          $RCSfile: hyper2.c,v $
// AUTHOR:        $Author: roldan $
//                All code is my own except where credited to others.
// DATE:          $Date: 2011-04-12 13:58:09 $
//
// FUNCTIONS
// =========
//
...
#include <dprtbp2_2d.h>

// name OF FUNCTION: hyper2
//
// PURPOSE
// =======
// Consider a 2D map $F$ and its derivative $DF$.
...
int hyper2(double mu, double H, int n, double p[2], double eval[2], 
      double evec[4])
{
   ...
   status=dprtbp2_2d(mu,H,n,p,dp);
   if(status)
   {
      fprintf(stderr, \
	    "hyper2: error computing derivative of 2D Poincare map\n",n);
   ...
   {
      fprintf(stderr, "hyper2: eigenvalues are not real!\n",n);
      return(ERR_NOTREAL);
   }
