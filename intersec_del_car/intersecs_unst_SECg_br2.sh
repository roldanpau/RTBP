datfile=intersecs_unst_SECg_br2.dat
resfile=intersecs_unst_SECg_br2.res
errfile=intersecs_unst_SECg_br2.err
tmpfile=intersecs_unst_SECg_br2.res.tmp
...
cut -d ' ' -f 2-4 ../approxint_del_car/approxints_unst_SECg_br2.res \
    > temp4.txt    # n, h1, h2


# Header: mu, sec, branch, unstable flag, axis line $g=a$
echo "0.95387536e-3 SECg LEFT 0 3.14159265358979323844" > $datfile
