datfile=intersecs_unst_SEC1_br2_h2m.dat
resfile=intersecs_unst_SEC1_br2_h2m.res
errfile=intersecs_unst_SEC1_br2_h2m.err
tmpfile=intersecs_unst_SEC1_br2_h2m.res.tmp
...
echo "0.95387536e-3 SEC1 0 3.14157265358979323844" > $datfile
