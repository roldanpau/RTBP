datfile=intersecs_unst_SEC1_br1_h2p.dat
resfile=intersecs_unst_SEC1_br1_h2p.res
errfile=intersecs_unst_SEC1_br1_h2p.err
tmpfile=intersecs_unst_SEC1_br1_h2p.res.tmp
...
echo "0.95387536e-3 SEC1 0 3.14161265358979323844" > $datfile
