datfile=intersecs_st_SECg_br1.dat
resfile=intersecs_st_SECg_br1.res
errfile=intersecs_st_SECg_br1.err
tmpfile=intersecs_st_SECg_br1.res.tmp
...
cut -d ' ' -f 2-4 ../approxint_del_car/approxints_st_SECg_br1.res \
    > temp4.txt    # n, h1, h2


# Header: mu, sec, branch, unstable flag, axis line $g=a$
echo "0.95387536e-3 SECg RIGHT 1 3.14159265358979323844" > $datfile
