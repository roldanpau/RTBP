datfile=intersecs_unst_SECg2_br1.dat
resfile=intersecs_unst_SECg2_br1.res
errfile=intersecs_unst_SECg2_br1.err
tmpfile=intersecs_unst_SECg2_br1.res.tmp
...
cut -d ' ' -f 2-4 ../approxint_del_car/approxints_unst_SECg2_br1.res \
    > temp4.txt    # n, h1, h2


# Header: mu, sec, branch, unstable flag, axis line $g=a$
echo "0.95387536e-3 SECg2 RIGHT 0 0.0" > $datfile
