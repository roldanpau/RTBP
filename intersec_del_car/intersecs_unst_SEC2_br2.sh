datfile=intersecs_unst_SEC2_br2.dat
resfile=intersecs_unst_SEC2_br2.res
errfile=intersecs_unst_SEC2_br2.err
tmpfile=intersecs_unst_SEC2_br2.res.tmp
...
echo "0.95387536e-3 SEC2 0 0.0" > $datfile
