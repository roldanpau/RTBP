datfile=intersecs_unst_SEC2_br2_h1p.dat
resfile=intersecs_unst_SEC2_br2_h1p.res
errfile=intersecs_unst_SEC2_br2_h1p.err
tmpfile=intersecs_unst_SEC2_br2_h1p.res.tmp
