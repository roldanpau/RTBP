datfile=intersecs_unst_SEC1_br2_h1m.dat
resfile=intersecs_unst_SEC1_br2_h1m.res
errfile=intersecs_unst_SEC1_br2_h1m.err
tmpfile=intersecs_unst_SEC1_br2_h1m.res.tmp
...
echo "0.95387536e-3 SEC1 0 3.14158265358979323844" > $datfile
