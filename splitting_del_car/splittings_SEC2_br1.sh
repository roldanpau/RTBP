datfile=splittings_SEC2_br1.dat
resfile=splittings_SEC2_br1.res

cut -d ' ' -f 1 ../sec1sec2/sec1sec2.res  > temp1.txt   # H,
cut -d ' ' -f 2 niterates_SEC2_br1.res > temp2.txt      # sec
cut -d ' ' -f 4-5 ../hyper/hypers_SEC1.res  > temp3.txt # v_u[2] in SEC1
cut -d ' ' -f 4-5 ../hyper/hypers.res  > temp4.txt      # v_u[2] in SEC2
cut -d ' ' -f 3 niterates_SEC2_br1.res > temp5.txt      # n
cut -d ' ' -f 2-3 ../intersec_del_car/intersecs_unst_SEC2_br1.res > temp6.txt   # p_u[2]
