...
cut -d ' ' -f 2 ../approxint/approxints_st_br2.res  > temp3.txt   # n
cut -d ' ' -f 2-3 ../intersec/intersecs_st_br2.res > temp4.txt   # p_s[2]

# Header: mu, stable flag, RIGHT branch
echo "0.95387536e-3 1 0" > $DATFILE
