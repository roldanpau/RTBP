// ===================================================================
// Take points on section SEC1 to section SEC2 by backward integration
// ===================================================================
// FILE:          $RCSfile: sec1sec2del_inv_main.c,v $
...
//
//    2.2. Take x from section SEC1 to section SEC2 by the backward flow.
//
...
#include "prtbpdel_2d.h"	// sec1sec2_del_inv
...
int main( )
{
   ...
   {
      // Take x from section SEC1 to section SEC2 by the backward flow.
      status=sec1sec2_del_inv(mu,H,x,&ti);
      if(status)
      {
	 fprintf(stderr, \
