datfile=approxints_st_SECg_br1.dat
resfile=approxints_st_SECg_br1.res
errfile=approxints_st_SECg_br1.err
...
echo "0.95387536e-3 SECg 2 1 1 3.14159265358979323844" > $datfile
