datfile=approxints_unst_SECg_br1.dat
resfile=approxints_unst_SECg_br1.res
errfile=approxints_unst_SECg_br1.err
...
echo "0.95387536e-3 SECg 2 0 1 3.14159265358979323844" > $datfile
